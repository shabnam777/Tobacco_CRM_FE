...
class _LeadsScreenState extends ConsumerState<LeadsScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => ref.read(leadsProvider.notifier).loadLeads());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              icon: const Icon(Icons.refresh_rounded, color: AppColors.textMuted), onPressed: () => ref.read(leadsProvider.notifier).loadLeads()),
        ],
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: _search.text.isNotEmpty
                              ? GestureDetector(
                                  onTap: () {
                                    _search.clear();
                                    ref.read(leadsProvider.notifier).setSearch('');
                                  },
                          ...
                          focusedBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: AppColors.accentBlue, width: 2))),
                      ...
                      return Tab(
                        ...
                        if (count > 0) ...[
                          ...
                          Container(
                              ...
                              child: Text('$count',
                                  style: GoogleFonts.nunitoSans(fontSize: 10, fontWeight: FontWeight.w700, color: AppColors.accentBlue))),
                        ],
                      ]));
                    }).toList());
              }),
      ...
      body: TabBarView(controller: _tabs, children: _tabDefs.map((t) => _LeadList(status: t.$2)).toList()),
    ...
    if (state.isLoading && leads.isEmpty) {
      return ListView.builder(
          ...
          itemBuilder: (_, __) => Container(
              ...
              decoration:
                  BoxDecoration(color: AppColors.bgCard, borderRadius: BorderRadius.circular(14), border: Border.all(color: AppColors.border))));
    }
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            if (constraints.maxWidth >= 1200) {
              crossAxisCount = 3; // desktop/laptop
            ...
            return GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                crossAxisSpacing: 12,
                mainAxisSpacing: 12,
                childAspectRatio: 3.2, // adjust UI card height
              ),
    ...
    showDialog(
        ...
        builder: (_) => AlertDialog(
                ...
                actions: [
                  ...
                  TextButton(
                      onPressed: () {
                        ref.read(leadsProvider.notifier).deleteLead(id);
                        Navigator.pop(ctx);
                      },
