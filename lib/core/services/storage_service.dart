...
class StorageService {
  ...
  static Future<void> saveUser(Map<String, dynamic> u) async => prefs.setString('current_user', jsonEncode(u));
  ...
  static Future<void> saveSettings(Map<String, dynamic> s) async => prefs.setString('app_settings', jsonEncode(s));
  static Map<String, dynamic> getSettings() {
    ...
    return {
      ...
      'companyName': '',
      'companyCity': 'India',
      'defaultProduct': 'Premium Indian Beedi & Tobacco',
      'mondayAutomation': true,
      'fridayDiscovery': true,
    };
  }

  static String getBackendUrl() => AppConfig.backendUrl;
  ...
  static Future<void> cacheLeads(List<dynamic> l) async => prefs.setString('cached_leads', jsonEncode(l));
